...
const LandingNav = () => {
  ...
  return (
    <div className={`bg-primary-700 dark:bg-secondary-100 dark:text-primary transition-all duration-200 w-full fixed top-0 z-10 lg:rounded-2xl lg:absolute lg:top-5 lg:w-[95%] lg:mx-7`}>
      <div className={`flex justify-between items-center lg:flex-row lg:justify-around py-2 lg:py-3 lg:px-5 px-4 ${isOpen ? 'flex-col' : 'flex-row'} transition-all duration-300`}>
        <div className="flex items-center justify-between w-full lg:w-auto">
          ...
          <button onClick={() => setIsOpen(!isOpen)} className="text-2xl text-white lg:hidden">
        ...
        <ul className={`${isOpen ? 'flex' : 'hidden'} lg:flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-5 text-sm lg:text-lg items-center lg:ml-6 mt-3 lg:mt-0 text-secondary`}>
          <li className="group relative dark:text-secondary-900">
            <Link to="/">Home</Link>
